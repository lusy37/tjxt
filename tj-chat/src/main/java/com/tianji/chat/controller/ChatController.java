...
public class ChatController {
    ...
    public String memoryChatRedis(@RequestParam(defaultValue = "我叫lusy") String message,
    ...
    @GetMapping(value = "/assistant/redis/stream", produces = "text/stream;charset=UTF-8")
    public Flux<String> memoryChatRedisStream(@RequestParam(defaultValue = "我叫lusy") String message,
                                              @RequestParam(defaultValue = "1") String memoryId) {
    ...
    public Flux<String> FileChatStream(@RequestParam(defaultValue = "我叫lusy") String message,
                                              @RequestParam(defaultValue = "1") String memoryId) {
